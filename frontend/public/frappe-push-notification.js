...
class FrappePushNotification {
	...
	async disableNotification() {
		...
		} catch (e) { // Added 'e' parameter which was missing
	...
	async registerTokenHandler(token) {
		try {
			...
			console.error(
				"Failed to register token to application server. Error: " + e.message
			)
			return false
		}
	}
	...
	async unregisterTokenHandler(token) {
		try {
			...
			console.error(
				"Failed to unregister token to application server. Error: " + e.message
			)
			return false
		}
	}
...
window.FrappePushNotification = FrappePushNotification 